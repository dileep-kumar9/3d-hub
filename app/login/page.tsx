      ...
      >
        ...
        <div className="login-card">
          ...
          <div className="heading-block">
            <p className="eyebrow">{isSuccess ? "Signed in" : "Welcome back"}</p>
            <h1 id="login-title">
              {isSuccess ? "Welcome back!" : "Log in to continue"}
            </h1>
            <p>
              {isSuccess
                ? "Taking you to your entertainment hub..."
                : "Continue watching movies, music, and immersive videos."}
            </p>
          </div>
          ...
          <p className="signup-copy">
            New to 3D Hub? <Link href="/signup">Create an account</Link>
          </p>
        </div>
      </section>
